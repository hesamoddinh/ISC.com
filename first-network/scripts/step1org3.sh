...
CC_SRC_PATH="github.com/chaincode/chaincode_ISC02/go/"
if [ "$LANGUAGE" = "node" ]; then
	CC_SRC_PATH="/opt/gopath/src/github.com/chaincode/chaincode_ISC02/node/"
fi
...
setGlobals 0 2
set -x
peer channel update -f org3_update_in_envelope.pb -c ${CHANNEL_NAME} -o orderer.ISC.com:7050 --tls --cafile ${ORDERER_CA}
set +x
